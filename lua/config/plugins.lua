return {
    ...
    {"AndrewRadev/switch.vim", lazy = false}, {
        ...
        keys = {{"gJ", "<cmd>TSJToggle<CR>", desc = "Toggle Split/Join"}},
        config = function()
    ...
    {"dhruvasagar/vim-table-mode", ft = {"markdown"}}, {
        ...
        keys = {
            "<C-n>", "<C-Up>", "<C-Down>", "<S-Up>", "<S-Down>", "<S-Left>",
            "<S-Right>"
        },
    ...
    {"folke/twilight.nvim", config = true, cond = EcoVim.plugins.zen.enabled},
    {
    ...
    }, -- Git
    {
        ...
        cmd = {
            "LazyGit", "LazyGitCurrentFile", "LazyGitFilterCurrentFile",
            "LazyGitFilter"
        },
        config = function()
    ...
    }, -- DAP
    {
        ...
        keys = {
            "<Leader>da", "<Leader>db", "<Leader>dc", "<Leader>dd",
            "<Leader>dh", "<Leader>di", "<Leader>do", "<Leader>dO", "<Leader>dt"
        },
        dependencies = {
