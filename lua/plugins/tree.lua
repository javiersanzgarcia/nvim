...
local keymappings = {
    ...
    {key = "g?", action = "toggle_help"}, {key = "W", action = "collapse_all"},
...
nvim_tree_events.on_tree_open(function()
    bufferline_api.set_offset(TREE_WIDTH + 1,
                              utils.add_whitespaces(13) .. "File Explorer")
end)

nvim_tree_events.on_tree_close(function() bufferline_api.set_offset(0) end)
